...
#  Created by Encounter(R) RTL Compiler RC14.13 - v14.10-s027_1 on Mon Oct 04 14:49:37 -0700 2021
...
create_clock -name "clk" -add -period 20.0 -waveform {0.0 10.0} [get_ports clk_i]
