...
usage -auto -elapse
set log file fv/level_fsm/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root level_fsm -rootonly \

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/level_fsm/g1.v.gz
} else {
...
elaborate design -revised -root level_fsm
